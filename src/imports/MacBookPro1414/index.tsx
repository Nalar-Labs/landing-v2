    ...
    <div className="bg-[#f8f8f8] flex-[1_0_0] h-[300px] min-w-px relative rounded-[30px]">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col items-start justify-between p-[30px] relative size-full">
          <p className="font-['Public_Sans:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[32px] text-black tracking-[-0.96px] w-full">{`AI Strategy & Implementation Roadmap`}</p>
...
export default function MacBookPro() {
  return (
    <div className="bg-white relative size-full" data-name="MacBook Pro 14' - 14">
      ...
      <p className="[word-break:break-word] absolute font-['Public_Sans:Light',sans-serif] font-light leading-[normal] left-[47px] text-[64px] text-black top-[265px] tracking-[-1.92px] whitespace-nowrap">Consultation</p>
      <Frame2 />
      <Group />
    </div>
  );
