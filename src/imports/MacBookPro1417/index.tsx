import svgPaths from "./svg-c24yjf3dph";
import imgImage50 from "./15cd34f6f07b82a0b9da0ec25bb5a5f82849256c.png";
import imgFrame12 from "./d67e92db977f1068a9b18590f9203fdf9298f5f0.png";
...
function Frame2() {
  return (
    <div className="absolute h-[628px] left-[57px] overflow-clip rounded-[30px] top-[211px] w-[1403px]">
      <div aria-hidden className="absolute inset-0 pointer-events-none rounded-[30px]">
        <div className="absolute inset-0 overflow-hidden rounded-[30px]">
          <img alt="" className="absolute h-[216%] left-[-13.59%] max-w-none top-[-53.15%] w-[128.91%]" src={imgFrame12} />
        </div>
        <div className="absolute bg-[rgba(0,0,0,0.25)] inset-0 rounded-[30px]" />
      </div>
